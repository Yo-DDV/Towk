...
| `push_client_id` | `optional string` | Stable browser-installation ID shared with Web Push and realtime presence. When present, rows suppressed while this installation was foreground are omitted. |
...
| `push_client_id` | `optional string` | Stable browser-installation ID used for per-client notification-center visibility. |
