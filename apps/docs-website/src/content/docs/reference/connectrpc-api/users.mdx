...
<a id="chatto-api-v1-UserService-GetUserProfile"></a>
...
```http
POST /api/connect/chatto.api.v1.UserService/GetUserProfile
```

<a id="chatto-api-v1-GetUserProfileRequest"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `target.user_id` | `string` | No field description provided. |
| `target.login` | `string` | No field description provided. |


<a id="chatto-api-v1-GetUserProfileResponse"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `profile` | [`UserProfile`](/reference/connectrpc-api/types/#chatto-api-v1-UserProfile) | No field description provided. |
