...
description: Generated shared message and enum reference for Towk ConnectRPC services.
editUrl: false
---
...
| `show_last_activity` | `bool` | Whether other authenticated server members may see last activity. The API returns true when no explicit preference has been stored. |
| `read_receipts_enabled` | `bool` | Whether the viewer publishes and may inspect reciprocal read receipts. |
...
| `voice_message` | [`MessageVoiceMetadata`](#chatto-api-v1-MessageVoiceMetadata) | Voice-message metadata. Absent for ordinary audio attachments. |
...
<a id="chatto-api-v1-MessageVoiceMetadata"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `duration_ms` | `int64` | Measured recording duration in milliseconds. |
| `waveform_peaks` | `repeated float` | Normalized amplitude envelope used to render the waveform. |
...
| `voice_message` | [`MessageVoiceMetadata`](#chatto-api-v1-MessageVoiceMetadata) | Voice-message metadata. Absent for ordinary audio assets. |
...
| `voice_message` | [`MessageVoiceMetadata`](#chatto-api-v1-MessageVoiceMetadata) | Voice-message metadata supplied when this is a recorder upload. |
...
| `roles` | `repeated string` | Explicit roles assigned to the user. Member listings include the virtual `everyone` role for parity with Towk's permission model. |
...
| Field | Type | Description |
| --- | --- | --- |
| `user` | [`User`](#chatto-api-v1-User) | Public identity, presence, and custom status. |
| `roles` | repeated [`UserProfileRole`](#chatto-api-v1-UserProfileRole) | All explicitly assigned roles, ordered for presentation. |
| `joined_at` | `google.protobuf.Timestamp` | Account/server join time when known. |
| `biography_markdown` | `string` | Sanitized Markdown source stored by the profile owner. |
| `last_activity` | `optional google.protobuf.Timestamp` | Latest coalesced activity time when visible and available. |
| `last_activity_visible` | `bool` | Whether the target currently allows last activity to be disclosed. |
| `viewer_is_self` | `bool` | Whether the profile belongs to the authenticated viewer. |
| `viewer_can_message` | `bool` | Whether the viewer may start a direct message with this user. |
| `viewer_can_call` | `bool` | Whether the viewer may start a direct call with this user. |

<a id="chatto-api-v1-UserProfileRole"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `name` | `string` | Stable configured role name. |
| `display_name` | `string` | Administrator-configured display name. |
| `position` | `int32` | Display ordering hint. This is not an authorization rank. |
| `moderation` | `bool` | True when the role carries moderation or administration authority. |

<a id="chatto-api-v1-NativeEndpoint"></a>
...
| `platform` | [`NativeNotificationPlatform`](#chatto-api-v1-NativeNotificationPlatform) | No field description provided. |
| `transport` | [`NativeNotificationTransport`](#chatto-api-v1-NativeNotificationTransport) | No field description provided. |
| `app_id` | `string` | No field description provided. |
| `fcm_installation_id` | `string` | Present only for the endpoint owner. Never written to logs. |
| `client_public_key` | `bytes` | Public installation encryption key. The private key stays on the client. |
| `locale` | `string` | No field description provided. |
| `created_at` | `google.protobuf.Timestamp` | No field description provided. |
| `last_seen_at` | `google.protobuf.Timestamp` | No field description provided. |
| `disabled_at` | `google.protobuf.Timestamp` | No field description provided. |
| `state` | [`NativeEndpointState`](#chatto-api-v1-NativeEndpointState) | No field description provided. |
| `last_delivery_status` | [`NativeDeliveryStatus`](#chatto-api-v1-NativeDeliveryStatus) | No field description provided. |
| `preferences` | [`NativeEndpointPreferences`](#chatto-api-v1-NativeEndpointPreferences) | No field description provided. |
| `generation` | `uint64` | No field description provided. |

<a id="chatto-api-v1-NativeEndpointPreferences"></a>

### NativeEndpointPreferences
...
| `messages` | `bool` | No field description provided. |
| `calls` | `bool` | No field description provided. |

<a id="chatto-api-v1-NativeEndpointPreferencesPatch"></a>

### NativeEndpointPreferencesPatch

No message description provided.

| Field | Type | Description |
| --- | --- | --- |
| `enabled` | `optional bool` | No field description provided. |
| `messages` | `optional bool` | No field description provided. |
| `calls` | `optional bool` | No field description provided. |

<a id="chatto-api-v1-ReadReceiptReader"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `user` | [`User`](#chatto-api-v1-User) | No field description provided. |
| `read_at` | `google.protobuf.Timestamp` | No field description provided. |

<a id="chatto-api-v1-ReadReceiptSummary"></a>
...
| `reader_count` | `int32` | No field description provided. |
...
| `call_id` | `string` | Stable call session ID. |
| `participant_id` | `string` | Exact media-session participant ID for join and leave entries. |
| `device_index` | `uint32` | Stable display slot for concurrent connections from the same account. |
...
| `event.room_posting_policy_changed` | [`RoomTimelinePostingPolicyEvent`](#chatto-api-v1-RoomTimelinePostingPolicyEvent) | The channel posting policy changed. |
| `event.room_history_purged` | [`RoomTimelineHistoryPurgedEvent`](#chatto-api-v1-RoomTimelineHistoryPurgedEvent) | Earlier message-owned history was purged. |
...
| `event.call_participant_joined` | [`RoomTimelineCallEvent`](#chatto-api-v1-RoomTimelineCallEvent) | One participant connection joined the voice call. |
| `event.call_participant_left` | [`RoomTimelineCallEvent`](#chatto-api-v1-RoomTimelineCallEvent) | One participant connection left the voice call. |
| `event.call_ended` | [`RoomTimelineCallEvent`](#chatto-api-v1-RoomTimelineCallEvent) | The voice call ended. |

<a id="chatto-api-v1-RoomTimelineHistoryPurgedEvent"></a>

### RoomTimelineHistoryPurgedEvent
...
| `history_epoch` | `uint64` | No field description provided. |
...
<a id="chatto-api-v1-RoomTimelinePostingPolicyEvent"></a>

### RoomTimelinePostingPolicyEvent
...
| --- | --- | --- |
| `room_id` | `string` | No field description provided. |
| `locked` | `bool` | No field description provided. |
...
| `posting_policy` | [`RoomPostingPolicy`](#chatto-api-v1-RoomPostingPolicy) | Durable posting state. Direct-message rooms always return OPEN. |
| `history_epoch` | `uint64` | Monotonic generation advanced after each history purge. |
| `revision` | `uint64` | Optimistic-concurrency token for room-scoped governance commands. |
...
<a id="chatto-api-v1-RoomHistoryPurgeOperation"></a>

### RoomHistoryPurgeOperation
...
| `room_id` | `string` | No field description provided. |
| `history_epoch` | `uint64` | No field description provided. |
| `status` | [`RoomHistoryPurgeStatus`](#chatto-api-v1-RoomHistoryPurgeStatus) | No field description provided. |
| `failure_code` | `string` | No field description provided. |
...
<a id="chatto-api-v1-CallStartedNotification"></a>

### CallStartedNotification

Notification that a call started in a joined room or private conversation.

| Field | Type | Description |
| --- | --- | --- |
| `room` | [`RoomSummary`](#chatto-api-v1-RoomSummary) | Room where the call started. |
| `event_id` | `string` | Durable call-start event ID. |
| `call_id` | `string` | Stable call session ID used by explicit join actions. |
| `missed` | `bool` | The call ended before the recipient joined it. |
...
| `thread_root_event_id` | `optional string` | Thread root event ID when the DM was posted inside a thread. |
...
| `message_preview` | `string` | Bounded message preview resolved at read time. Notification records remain content-free; this is empty when the message is unavailable or has no text. |
...
| `kind.call_started` | [`CallStartedNotification`](#chatto-api-v1-CallStartedNotification) | Call-start notification for All Messages recipients. |
...
| `event_id` | `string` | Message event ID. |
| `thread_root_event_id` | `optional string` | Thread root event ID when the message was posted inside a thread. |
...
| `color` | `string` | Display-only accent color in canonical #RRGGBB form. Empty means the ordinary text color (used by the implicit everyone role). |
...
| Field | Type | Description |
| --- | --- | --- |
| `name` | `string` | Display name of the Towk server. |
...
| `capabilities` | `repeated string` | Stable, additive feature identifiers supported by this server. Clients must ignore unknown values and require an explicit match before using a capability whose fallback would not be safe. |
...
| `max_voice_message_upload_size` | `int64` | Maximum first-class voice-message upload size in bytes. |
...
| `call_id` | `string` | Active call session ID. |
| `participant_id` | `string` | Stable media-session participant ID for this browser/device connection. |
| `device_index` | `uint32` | Stable display slot for concurrent connections from the same account. |
| `connection_state` | [`CallParticipantConnectionState`](#chatto-api-v1-CallParticipantConnectionState) | Last authoritative media-server connection state. |
| `interruption_deadline` | `google.protobuf.Timestamp` | Recovery deadline while the connection is interrupted. |
...
| Field | Type | Description |
| --- | --- | --- |
| `connected` | `bool` | Whether Towk is currently connected to NATS. |
...
<a id="chatto-admin-v1-AdminPerformanceEnvelope"></a>

### AdminPerformanceEnvelope

Process-visible resource envelope used to compute effective values.

| Field | Type | Description |
| --- | --- | --- |
| `cpus` | `int32` | No field description provided. |
| `memory_bytes` | `int64` | No field description provided. |
| `cpu_source` | `string` | No field description provided. |
| `memory_source` | `string` | No field description provided. |

<a id="chatto-admin-v1-AdminPerformanceLimitCap"></a>

### AdminPerformanceLimitCap

Reduction reasons for one runtime work pool.

| Field | Type | Description |
| --- | --- | --- |
| `field` | [`AdminPerformanceLimitField`](#chatto-admin-v1-AdminPerformanceLimitField) | No field description provided. |
| `reasons` | repeated [`AdminPerformanceCapReason`](#chatto-admin-v1-AdminPerformanceCapReason) | No field description provided. |

<a id="chatto-admin-v1-AdminPerformanceLimits"></a>

### AdminPerformanceLimits

Bounded worker values for one runtime performance policy.

| Field | Type | Description |
| --- | --- | --- |
| `image_transform_workers` | `int32` | No field description provided. |
| `image_transform_admissions` | `int32` | No field description provided. |
| `asset_upload_workers` | `int32` | No field description provided. |
| `link_preview_workers` | `int32` | No field description provided. |
| `video_workers` | `int32` | No field description provided. |

<a id="chatto-admin-v1-AdminPerformanceSettings"></a>
...
| Field | Type | Description |
| --- | --- | --- |
| `requested_profile` | [`AdminPerformanceProfile`](#chatto-admin-v1-AdminPerformanceProfile) | No field description provided. |
| `effective_profile` | [`AdminPerformanceProfile`](#chatto-admin-v1-AdminPerformanceProfile) | No field description provided. |
| `source` | [`AdminPerformancePolicySource`](#chatto-admin-v1-AdminPerformancePolicySource) | No field description provided. |
| `schema_version` | `uint32` | No field description provided. |
| `revision` | `string` | No field description provided. |
| `requested_limits` | [`AdminPerformanceLimits`](#chatto-admin-v1-AdminPerformanceLimits) | No field description provided. |
| `effective_limits` | [`AdminPerformanceLimits`](#chatto-admin-v1-AdminPerformanceLimits) | No field description provided. |
| `operator_caps` | [`AdminPerformanceLimits`](#chatto-admin-v1-AdminPerformanceLimits) | No field description provided. |
| `envelope` | [`AdminPerformanceEnvelope`](#chatto-admin-v1-AdminPerformanceEnvelope) | No field description provided. |
| `caps` | repeated [`AdminPerformanceLimitCap`](#chatto-admin-v1-AdminPerformanceLimitCap) | No field description provided. |
| `policy_error` | `string` | No field description provided. |
| `restart_required` | `bool` | No field description provided. |
...
| `stats` | [`AdminServerStats`](#chatto-admin-v1-AdminServerStats) | Aggregate Towk object counts. |
...
| `payload_json` | `string` | Pretty-printed JSON representation of the event payload. Credential material such as password hashes is omitted from this diagnostic view. |
...
| `can_lock_room` | `bool` | Effective action capability for the current viewer. |
| `can_purge_messages` | `bool` | Effective selective-history purge capability for the current viewer. |
...
| `read_receipts_enabled` | `bool` | Whether members may publish and inspect reciprocal read receipts. |
...
| `NOTIFICATION_LEVEL_NORMAL` | `3` | Notify only for mentions in channel rooms; direct messages still notify. |
...
<a id="chatto-api-v1-NativeDeliveryStatus"></a>
...
| Name | Number | Description |
| --- | --- | --- |
| `NATIVE_DELIVERY_STATUS_UNSPECIFIED` | `0` | No value description provided. |
| `NATIVE_DELIVERY_STATUS_NEVER_ATTEMPTED` | `1` | No value description provided. |
| `NATIVE_DELIVERY_STATUS_PENDING` | `2` | No value description provided. |
| `NATIVE_DELIVERY_STATUS_DELIVERED_TO_TRANSPORT` | `3` | No value description provided. |
| `NATIVE_DELIVERY_STATUS_RETRYABLE_FAILURE` | `4` | No value description provided. |
| `NATIVE_DELIVERY_STATUS_EXPIRED` | `5` | No value description provided. |
| `NATIVE_DELIVERY_STATUS_PERMANENTLY_INVALID` | `6` | No value description provided. |

<a id="chatto-api-v1-NativeEndpointState"></a>
...
| Name | Number | Description |
| --- | --- | --- |
| `NATIVE_ENDPOINT_STATE_UNSPECIFIED` | `0` | No value description provided. |
| `NATIVE_ENDPOINT_STATE_ACTIVE` | `1` | No value description provided. |
| `NATIVE_ENDPOINT_STATE_DISABLED` | `2` | No value description provided. |
| `NATIVE_ENDPOINT_STATE_PERMANENTLY_INVALID` | `3` | No value description provided. |

<a id="chatto-api-v1-NativeNotificationPlatform"></a>
...
| Name | Number | Description |
| --- | --- | --- |
| `NATIVE_NOTIFICATION_PLATFORM_UNSPECIFIED` | `0` | No value description provided. |
| `NATIVE_NOTIFICATION_PLATFORM_ANDROID` | `1` | No value description provided. |
| `NATIVE_NOTIFICATION_PLATFORM_LINUX` | `2` | No value description provided. |
| `NATIVE_NOTIFICATION_PLATFORM_WINDOWS` | `3` | No value description provided. |
| `NATIVE_NOTIFICATION_PLATFORM_MACOS` | `4` | No value description provided. |
| `NATIVE_NOTIFICATION_PLATFORM_IOS` | `5` | No value description provided. |

<a id="chatto-api-v1-NativeNotificationTransport"></a>

### NativeNotificationTransport

No enum description provided.

| Name | Number | Description |
| --- | --- | --- |
| `NATIVE_NOTIFICATION_TRANSPORT_UNSPECIFIED` | `0` | No value description provided. |
| `NATIVE_NOTIFICATION_TRANSPORT_ANDROID_MANAGED_FCM` | `1` | Android wake signals sent through the Towk-operated FCM relay. |
| `NATIVE_NOTIFICATION_TRANSPORT_LINUX_RESIDENT_WEBSOCKET` | `2` | Linux notifications derived from the authenticated instance WebSocket. |

<a id="chatto-api-v1-RoomHistoryPurgeStatus"></a>
...
| Name | Number | Description |
| --- | --- | --- |
| `ROOM_HISTORY_PURGE_STATUS_UNSPECIFIED` | `0` | No value description provided. |
| `ROOM_HISTORY_PURGE_STATUS_RUNNING` | `1` | No value description provided. |
| `ROOM_HISTORY_PURGE_STATUS_COMPLETED` | `2` | No value description provided. |
| `ROOM_HISTORY_PURGE_STATUS_FAILED` | `3` | No value description provided. |
...
<a id="chatto-api-v1-RoomPostingPolicy"></a>
...
| Name | Number | Description |
| --- | --- | --- |
| `ROOM_POSTING_POLICY_UNSPECIFIED` | `0` | No value description provided. |
| `ROOM_POSTING_POLICY_OPEN` | `1` | Members may add content according to their ordinary permissions. |
| `ROOM_POSTING_POLICY_LOCKED` | `2` | New content is blocked unless the viewer has room.bypass-lock. |
...
<a id="chatto-api-v1-CallParticipantConnectionState"></a>

### CallParticipantConnectionState

No enum description provided.

| Name | Number | Description |
| --- | --- | --- |
| `CALL_PARTICIPANT_CONNECTION_STATE_UNSPECIFIED` | `0` | No value description provided. |
| `CALL_PARTICIPANT_CONNECTION_STATE_CONNECTED` | `1` | No value description provided. |
| `CALL_PARTICIPANT_CONNECTION_STATE_INTERRUPTED` | `2` | No value description provided. |

<a id="chatto-api-v1-JoinCallMode"></a>
...
| Name | Number | Description |
| --- | --- | --- |
| `JOIN_CALL_MODE_UNSPECIFIED` | `0` | Ask the server to join directly only when no other device is connected. |
| `JOIN_CALL_MODE_COMPANION` | `1` | Keep existing devices connected and join muted as a companion device. |
| `JOIN_CALL_MODE_TRANSFER` | `2` | Disconnect existing devices for the account and continue on this device. |

<a id="chatto-api-v1-JoinCallStatus"></a>
...
| Name | Number | Description |
| --- | --- | --- |
| `JOIN_CALL_STATUS_UNSPECIFIED` | `0` | No value description provided. |
| `JOIN_CALL_STATUS_JOINED` | `1` | The connection was admitted to the call. |
| `JOIN_CALL_STATUS_SELECTION_REQUIRED` | `2` | Another device is active and the user must choose companion or transfer. |

<a id="chatto-admin-v1-AdminPerformanceCapReason"></a>
...
| Name | Number | Description |
| --- | --- | --- |
| `ADMIN_PERFORMANCE_CAP_REASON_UNSPECIFIED` | `0` | No value description provided. |
| `ADMIN_PERFORMANCE_CAP_REASON_OPERATOR_CAP` | `1` | No value description provided. |
| `ADMIN_PERFORMANCE_CAP_REASON_PROCESS_CPU` | `2` | No value description provided. |
| `ADMIN_PERFORMANCE_CAP_REASON_PROCESS_MEMORY` | `3` | No value description provided. |

<a id="chatto-admin-v1-AdminPerformanceLimitField"></a>
...
| Name | Number | Description |
| --- | --- | --- |
| `ADMIN_PERFORMANCE_LIMIT_FIELD_UNSPECIFIED` | `0` | No value description provided. |
| `ADMIN_PERFORMANCE_LIMIT_FIELD_IMAGE_TRANSFORM_WORKERS` | `1` | No value description provided. |
| `ADMIN_PERFORMANCE_LIMIT_FIELD_IMAGE_TRANSFORM_ADMISSIONS` | `2` | No value description provided. |
| `ADMIN_PERFORMANCE_LIMIT_FIELD_ASSET_UPLOAD_WORKERS` | `3` | No value description provided. |
| `ADMIN_PERFORMANCE_LIMIT_FIELD_LINK_PREVIEW_WORKERS` | `4` | No value description provided. |
| `ADMIN_PERFORMANCE_LIMIT_FIELD_VIDEO_WORKERS` | `5` | No value description provided. |

<a id="chatto-admin-v1-AdminPerformancePolicySource"></a>
...
| Name | Number | Description |
| --- | --- | --- |
| `ADMIN_PERFORMANCE_POLICY_SOURCE_UNSPECIFIED` | `0` | No value description provided. |
| `ADMIN_PERFORMANCE_POLICY_SOURCE_HISTORICAL` | `1` | No value description provided. |
| `ADMIN_PERFORMANCE_POLICY_SOURCE_OPERATOR_DEFAULT` | `2` | No value description provided. |
| `ADMIN_PERFORMANCE_POLICY_SOURCE_OWNER` | `3` | No value description provided. |
| `ADMIN_PERFORMANCE_POLICY_SOURCE_ADAPTIVE` | `4` | No value description provided. |

<a id="chatto-admin-v1-AdminPerformanceProfile"></a>
...
| Name | Number | Description |
| --- | --- | --- |
| `ADMIN_PERFORMANCE_PROFILE_UNSPECIFIED` | `0` | No value description provided. |
| `ADMIN_PERFORMANCE_PROFILE_ECONOMY` | `1` | No value description provided. |
| `ADMIN_PERFORMANCE_PROFILE_BALANCED` | `2` | No value description provided. |
| `ADMIN_PERFORMANCE_PROFILE_PERFORMANCE` | `3` | No value description provided. |
| `ADMIN_PERFORMANCE_PROFILE_CUSTOM` | `4` | No value description provided. |
| `ADMIN_PERFORMANCE_PROFILE_LEGACY` | `5` | No value description provided. |
| `ADMIN_PERFORMANCE_PROFILE_ADAPTIVE` | `6` | No value description provided. |
