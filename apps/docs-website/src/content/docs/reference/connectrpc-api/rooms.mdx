...
<a id="chatto-api-v1-RoomService-LockRoom"></a>
...
```http
POST /api/connect/chatto.api.v1.RoomService/LockRoom
```

<a id="chatto-api-v1-LockRoomRequest"></a>
...
| `expected_revision` | `uint64` | No field description provided. |


<a id="chatto-api-v1-LockRoomResponse"></a>

#### Result: LockRoomResponse

Result of locking a channel.

| Field | Type | Description |
| --- | --- | --- |
| `room` | [`Room`](/reference/connectrpc-api/types/#chatto-api-v1-Room) | No field description provided. |


<a id="chatto-api-v1-RoomService-UnlockRoom"></a>
...
```http
POST /api/connect/chatto.api.v1.RoomService/UnlockRoom
```

<a id="chatto-api-v1-UnlockRoomRequest"></a>

#### Input: UnlockRoomRequest
...
<a id="chatto-api-v1-UnlockRoomResponse"></a>

#### Result: UnlockRoomResponse
...
<a id="chatto-api-v1-RoomService-PurgeRoomHistory"></a>
...
```http
POST /api/connect/chatto.api.v1.RoomService/PurgeRoomHistory
```

<a id="chatto-api-v1-PurgeRoomHistoryRequest"></a>

#### Input: PurgeRoomHistoryRequest
...
| `room_id` | `string` | No field description provided. |
| `expected_revision` | `uint64` | No field description provided. |
| `confirmation_name` | `string` | No field description provided. |
| `current_password` | `string` | Optional current-password proof when the active credential is not fresh. |


<a id="chatto-api-v1-PurgeRoomHistoryResponse"></a>

#### Result: PurgeRoomHistoryResponse
...
| --- | --- | --- |
| `room` | [`Room`](/reference/connectrpc-api/types/#chatto-api-v1-Room) | No field description provided. |
| `operation` | [`RoomHistoryPurgeOperation`](/reference/connectrpc-api/types/#chatto-api-v1-RoomHistoryPurgeOperation) | No field description provided. |


<a id="chatto-api-v1-RoomService-GetRoomHistoryPurgeOperation"></a>
...
```http
POST /api/connect/chatto.api.v1.RoomService/GetRoomHistoryPurgeOperation
```

<a id="chatto-api-v1-GetRoomHistoryPurgeOperationRequest"></a>

#### Input: GetRoomHistoryPurgeOperationRequest

Request to read a history-purge operation.

| Field | Type | Description |
| --- | --- | --- |
| `operation_id` | `string` | No field description provided. |


<a id="chatto-api-v1-GetRoomHistoryPurgeOperationResponse"></a>

#### Result: GetRoomHistoryPurgeOperationResponse
...
<a id="chatto-api-v1-RoomService-AdvanceReadReceipt"></a>
...
```http
POST /api/connect/chatto.api.v1.RoomService/AdvanceReadReceipt
```

<a id="chatto-api-v1-AdvanceReadReceiptRequest"></a>

#### Input: AdvanceReadReceiptRequest
...
| `up_to_event_id` | `string` | No field description provided. |


<a id="chatto-api-v1-AdvanceReadReceiptResponse"></a>

#### Result: AdvanceReadReceiptResponse

No message description provided.

| Field | Type | Description |
| --- | --- | --- |
| `updated` | `bool` | No field description provided. |


<a id="chatto-api-v1-RoomService-GetReadReceiptSummaries"></a>

### GetReadReceiptSummaries

Returns bounded reader counts for rendered messages.

```http
POST /api/connect/chatto.api.v1.RoomService/GetReadReceiptSummaries
```

<a id="chatto-api-v1-GetReadReceiptSummariesRequest"></a>

#### Input: GetReadReceiptSummariesRequest
...
| `room_id` | `string` | No field description provided. |
| `thread_root_event_id` | `string` | No field description provided. |
| `message_event_ids` | `repeated string` | No field description provided. |


<a id="chatto-api-v1-GetReadReceiptSummariesResponse"></a>

#### Result: GetReadReceiptSummariesResponse
...
| `summaries` | repeated [`ReadReceiptSummary`](/reference/connectrpc-api/types/#chatto-api-v1-ReadReceiptSummary) | No field description provided. |


<a id="chatto-api-v1-RoomService-ListReadReceiptReaders"></a>

### ListReadReceiptReaders

Lists current authorized readers for one message with bounded pagination.

```http
POST /api/connect/chatto.api.v1.RoomService/ListReadReceiptReaders
```

<a id="chatto-api-v1-ListReadReceiptReadersRequest"></a>

#### Input: ListReadReceiptReadersRequest
...
<a id="chatto-api-v1-ListReadReceiptReadersResponse"></a>

#### Result: ListReadReceiptReadersResponse
...
| --- | --- | --- |
| `enabled` | `bool` | No field description provided. |
| `readers` | repeated [`ReadReceiptReader`](/reference/connectrpc-api/types/#chatto-api-v1-ReadReceiptReader) | No field description provided. |
