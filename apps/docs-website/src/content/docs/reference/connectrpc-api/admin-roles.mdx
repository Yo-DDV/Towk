...
| `color` | `optional string` | Optional display accent. Omission lets the server choose a stable default. |
...
| `color` | `optional string` | Display accent to apply, in #RRGGBB form. |
