...
const msg_settings_profile_details_load_failed = (): LocalizedString => messages().settings_profile_details_load_failed(empty());
...
const msg_settings_profile_details_biography_label = (): LocalizedString => messages().settings_profile_details_biography_label(empty());
const msg_settings_profile_details_biography_placeholder = (): LocalizedString => messages().settings_profile_details_biography_placeholder(empty());
const msg_settings_profile_details_byte_count = (
  inputs: Parameters<LocaleMessages['settings_profile_details_byte_count']>[0]
): LocalizedString => messages().settings_profile_details_byte_count(inputs);
const msg_settings_profile_details_preview = (): LocalizedString => messages().settings_profile_details_preview(empty());
const msg_settings_profile_details_biography_too_large = (): LocalizedString => messages().settings_profile_details_biography_too_large(empty());
const msg_settings_profile_details_biography_saved = (): LocalizedString => messages().settings_profile_details_biography_saved(empty());
const msg_settings_profile_details_save_failed = (): LocalizedString => messages().settings_profile_details_save_failed(empty());
const msg_settings_profile_details_save_biography = (): LocalizedString => messages().settings_profile_details_save_biography(empty());
const msg_settings_profile_details_privacy_title = (): LocalizedString => messages().settings_profile_details_privacy_title(empty());
const msg_settings_profile_details_show_last_activity = (): LocalizedString => messages().settings_profile_details_show_last_activity(empty());
...
const msg_profile_roles = (): LocalizedString => messages().profile_roles(empty());
const msg_profile_member_role = (): LocalizedString => messages().profile_member_role(empty());
const msg_profile_joined = (): LocalizedString => messages().profile_joined(empty());
const msg_profile_last_activity = (): LocalizedString => messages().profile_last_activity(empty());
const msg_profile_last_activity_hidden = (): LocalizedString => messages().profile_last_activity_hidden(empty());
const msg_profile_last_activity_unavailable = (): LocalizedString => messages().profile_last_activity_unavailable(empty());
...
const msg_room_message_empty_edit = (): LocalizedString => messages().room_message_empty_edit(empty());
const msg_room_message_link_copied = (): LocalizedString => messages().room_message_link_copied(empty());
const msg_room_message_link_copy_failed = (): LocalizedString => messages().room_message_link_copy_failed(empty());
const msg_room_message_reply_target_not_loaded = (): LocalizedString => messages().room_message_reply_target_not_loaded(empty());
...
const msg_room_workspace_switcher = (): LocalizedString => messages().room_workspace_switcher(empty());
const msg_room_workspace_messages = (): LocalizedString => messages().room_workspace_messages(empty());
const msg_room_workspace_call = (): LocalizedString => messages().room_workspace_call(empty());
...
const msg_room_sidebar_show_members = (): LocalizedString => messages().room_sidebar_show_members(empty());
const msg_room_sidebar_hide_members = (): LocalizedString => messages().room_sidebar_hide_members(empty());
const msg_room_sidebar_show_files = (): LocalizedString => messages().room_sidebar_show_files(empty());
...
const msg_room_system_group_other_one = (
  inputs: Parameters<LocaleMessages['room_system_group_other_one']>[0]
): LocalizedString => messages().room_system_group_other_one(inputs);
const msg_room_system_group_other_many = (
  inputs: Parameters<LocaleMessages['room_system_group_other_many']>[0]
...
const msg_ui_pwa_install_action_install = (): LocalizedString => messages().ui_pwa_install_action_install(empty());
...
const msg_ui_pwa_install_benefits_label = (): LocalizedString => messages().ui_pwa_install_benefits_label(empty());
const msg_ui_pwa_install_benefit_launch = (): LocalizedString => messages().ui_pwa_install_benefit_launch(empty());
const msg_ui_pwa_install_benefit_focus = (): LocalizedString => messages().ui_pwa_install_benefit_focus(empty());
...
const msg_ui_pwa_install_installing = (): LocalizedString => messages().ui_pwa_install_installing(empty());
const msg_ui_pwa_install_install_failed = (): LocalizedString => messages().ui_pwa_install_install_failed(empty());
const msg_ui_pwa_install_manual_help = (): LocalizedString => messages().ui_pwa_install_manual_help(empty());
const msg_ui_pwa_install_recommended = (): LocalizedString => messages().ui_pwa_install_recommended(empty());
const msg_ui_pwa_install_confirm_add = (): LocalizedString => messages().ui_pwa_install_confirm_add(empty());
const msg_ui_pwa_install_confirm_install = (): LocalizedString => messages().ui_pwa_install_confirm_install(empty());
const msg_ui_pwa_install_ios_safari_title = (): LocalizedString => messages().ui_pwa_install_ios_safari_title(empty());
const msg_ui_pwa_install_ios_safari_share = (): LocalizedString => messages().ui_pwa_install_ios_safari_share(empty());
const msg_ui_pwa_install_ios_safari_home = (): LocalizedString => messages().ui_pwa_install_ios_safari_home(empty());
const msg_ui_pwa_install_ios_safari_open = (): LocalizedString => messages().ui_pwa_install_ios_safari_open(empty());
const msg_ui_pwa_install_ios_chrome_title = (): LocalizedString => messages().ui_pwa_install_ios_chrome_title(empty());
const msg_ui_pwa_install_ios_chrome_share = (): LocalizedString => messages().ui_pwa_install_ios_chrome_share(empty());
const msg_ui_pwa_install_ios_chrome_home = (): LocalizedString => messages().ui_pwa_install_ios_chrome_home(empty());
const msg_ui_pwa_install_ios_other_title = (): LocalizedString => messages().ui_pwa_install_ios_other_title(empty());
const msg_ui_pwa_install_ios_other_open = (): LocalizedString => messages().ui_pwa_install_ios_other_open(empty());
const msg_ui_pwa_install_ios_other_return = (): LocalizedString => messages().ui_pwa_install_ios_other_return(empty());
const msg_ui_pwa_install_android_chromium_title = (): LocalizedString => messages().ui_pwa_install_android_chromium_title(empty());
const msg_ui_pwa_install_android_chromium_menu = (): LocalizedString => messages().ui_pwa_install_android_chromium_menu(empty());
const msg_ui_pwa_install_android_chromium_install = (): LocalizedString => messages().ui_pwa_install_android_chromium_install(empty());
const msg_ui_pwa_install_android_firefox_title = (): LocalizedString => messages().ui_pwa_install_android_firefox_title(empty());
const msg_ui_pwa_install_android_firefox_menu = (): LocalizedString => messages().ui_pwa_install_android_firefox_menu(empty());
const msg_ui_pwa_install_android_firefox_install = (): LocalizedString => messages().ui_pwa_install_android_firefox_install(empty());
const msg_ui_pwa_install_android_other_title = (): LocalizedString => messages().ui_pwa_install_android_other_title(empty());
const msg_ui_pwa_install_android_other_open = (): LocalizedString => messages().ui_pwa_install_android_other_open(empty());
const msg_ui_pwa_install_android_other_return = (): LocalizedString => messages().ui_pwa_install_android_other_return(empty());
const msg_ui_pwa_install_android_troubleshoot = (): LocalizedString => messages().ui_pwa_install_android_troubleshoot(empty());
const msg_ui_pwa_install_windows_firefox_title = (): LocalizedString => messages().ui_pwa_install_windows_firefox_title(empty());
const msg_ui_pwa_install_windows_firefox_button = (): LocalizedString => messages().ui_pwa_install_windows_firefox_button(empty());
const msg_ui_pwa_install_windows_firefox_pin = (): LocalizedString => messages().ui_pwa_install_windows_firefox_pin(empty());
const msg_ui_pwa_install_macos_safari_title = (): LocalizedString => messages().ui_pwa_install_macos_safari_title(empty());
const msg_ui_pwa_install_macos_safari_share = (): LocalizedString => messages().ui_pwa_install_macos_safari_share(empty());
const msg_ui_pwa_install_macos_safari_dock = (): LocalizedString => messages().ui_pwa_install_macos_safari_dock(empty());
const msg_ui_pwa_install_desktop_chromium_title = (): LocalizedString => messages().ui_pwa_install_desktop_chromium_title(empty());
const msg_ui_pwa_install_desktop_chromium_icon = (): LocalizedString => messages().ui_pwa_install_desktop_chromium_icon(empty());
const msg_ui_pwa_install_desktop_chromium_menu = (): LocalizedString => messages().ui_pwa_install_desktop_chromium_menu(empty());
const msg_ui_pwa_install_desktop_firefox_unsupported_title = (): LocalizedString => messages().ui_pwa_install_desktop_firefox_unsupported_title(empty());
const msg_ui_pwa_install_desktop_firefox_unsupported_linux_description = (): LocalizedString => messages().ui_pwa_install_desktop_firefox_unsupported_linux_description(empty());
const msg_ui_pwa_install_desktop_firefox_unsupported_macos_description = (): LocalizedString => messages().ui_pwa_install_desktop_firefox_unsupported_macos_description(empty());
const msg_ui_pwa_install_desktop_firefox_supported_browsers_linux = (): LocalizedString => messages().ui_pwa_install_desktop_firefox_supported_browsers_linux(empty());
const msg_ui_pwa_install_desktop_firefox_supported_browsers_macos = (): LocalizedString => messages().ui_pwa_install_desktop_firefox_supported_browsers_macos(empty());
const msg_ui_pwa_install_desktop_other_title = (): LocalizedString => messages().ui_pwa_install_desktop_other_title(empty());
const msg_ui_pwa_install_desktop_other_open = (): LocalizedString => messages().ui_pwa_install_desktop_other_open(empty());
const msg_ui_pwa_install_desktop_other_open_chromium = (): LocalizedString => messages().ui_pwa_install_desktop_other_open_chromium(empty());
const msg_ui_pwa_install_desktop_other_open_macos = (): LocalizedString => messages().ui_pwa_install_desktop_other_open_macos(empty());
const msg_ui_pwa_install_desktop_other_return = (): LocalizedString => messages().ui_pwa_install_desktop_other_return(empty());
const msg_ui_pwa_install_reminder_title = (): LocalizedString => messages().ui_pwa_install_reminder_title(empty());
const msg_ui_pwa_install_reminder_message = (): LocalizedString => messages().ui_pwa_install_reminder_message(empty());
const msg_ui_pwa_install_show_guide = (): LocalizedString => messages().ui_pwa_install_show_guide(empty());
const msg_ui_pwa_install_later = (): LocalizedString => messages().ui_pwa_install_later(empty());
...
const msg_ui_update_after_call = (): LocalizedString => messages().ui_update_after_call(empty());
const msg_ui_update_waiting_for_call = (): LocalizedString => messages().ui_update_waiting_for_call(empty());
...
const msg_ui_image_modal_open_original = (): LocalizedString => messages().ui_image_modal_open_original(empty());
...
const msg_ui_user_combobox_empty = (): LocalizedString => messages().ui_user_combobox_empty(empty());
const msg_ui_user_combobox_clear_actor = (): LocalizedString => messages().ui_user_combobox_clear_actor(empty());
...
const msg_quick_switcher_missing_dm_target = (): LocalizedString => messages().quick_switcher_missing_dm_target(empty());
const msg_quick_switcher_start_dm_failed = (): LocalizedString => messages().quick_switcher_start_dm_failed(empty());
...
const msg_preview_copy_url_success = (): LocalizedString => messages().preview_copy_url_success(empty());
const msg_preview_copy_url_failed = (): LocalizedString => messages().preview_copy_url_failed(empty());
...
const msg_voice_dock_connected = (): LocalizedString => messages().voice_dock_connected(empty());
const msg_voice_dock_joining = (): LocalizedString => messages().voice_dock_joining(empty());
const msg_voice_dock_reconnecting = (): LocalizedString => messages().voice_dock_reconnecting(empty());
const msg_voice_dock_audio_blocked = (): LocalizedString => messages().voice_dock_audio_blocked(empty());
const msg_voice_dock_return_to_call = (
  inputs: Parameters<LocaleMessages['voice_dock_return_to_call']>[0]
): LocalizedString => messages().voice_dock_return_to_call(inputs);
const msg_voice_dock_session_label = (
  inputs: Parameters<LocaleMessages['voice_dock_session_label']>[0]
): LocalizedString => messages().voice_dock_session_label(inputs);
const msg_voice_joining = (): LocalizedString => messages().voice_joining(empty());
const msg_voice_recording_conflict = (): LocalizedString => messages().voice_recording_conflict(empty());
...
const msg_voice_switch_call_action = (): LocalizedString => messages().voice_switch_call_action(empty());
const msg_voice_switch_call_message = (): LocalizedString => messages().voice_switch_call_message(empty());
...
): LocalizedString => messages().voice_participant_packet_loss(inputs);
...
const msg_voice_phone_microphone = (): LocalizedString => messages().voice_phone_microphone(empty());
const msg_voice_headset_microphone = (): LocalizedString => messages().voice_headset_microphone(empty());
...
const msg_voice_camera_rear = (): LocalizedString => messages().voice_camera_rear(empty());
const msg_voice_camera_ultra_wide = (): LocalizedString => messages().voice_camera_ultra_wide(empty());
const msg_voice_camera_telephoto = (): LocalizedString => messages().voice_camera_telephoto(empty());
const msg_voice_switch_camera = (): LocalizedString => messages().voice_switch_camera(empty());
...
const msg_voice_system_default_device = (): LocalizedString => messages().voice_system_default_device(empty());
const msg_voice_default_communications_device = (): LocalizedString => messages().voice_default_communications_device(empty());
const msg_voice_choose_speaker = (): LocalizedString => messages().voice_choose_speaker(empty());
const msg_voice_no_devices = (): LocalizedString => messages().voice_no_devices(empty());
const msg_voice_system_managed_audio_output = (): LocalizedString => messages().voice_system_managed_audio_output(empty());
const msg_voice_microphone_processing_active = (): LocalizedString => messages().voice_microphone_processing_active(empty());
const msg_voice_microphone_processing_system = (): LocalizedString => messages().voice_microphone_processing_system(empty());
const msg_voice_microphone_processing_limited = (): LocalizedString => messages().voice_microphone_processing_limited(empty());
const msg_voice_microphone_processing_title = (): LocalizedString => messages().voice_microphone_processing_title(empty());
const msg_voice_microphone_noise_reduction = (): LocalizedString => messages().voice_microphone_noise_reduction(empty());
const msg_voice_microphone_auto_gain = (): LocalizedString => messages().voice_microphone_auto_gain(empty());
const msg_voice_microphone_echo_cancellation = (): LocalizedString => messages().voice_microphone_echo_cancellation(empty());
const msg_voice_microphone_processing_status_native = (): LocalizedString => messages().voice_microphone_processing_status_native(empty());
const msg_voice_microphone_processing_status_towk = (): LocalizedString => messages().voice_microphone_processing_status_towk(empty());
const msg_voice_microphone_processing_status_requested = (): LocalizedString => messages().voice_microphone_processing_status_requested(empty());
const msg_voice_microphone_processing_status_unavailable = (): LocalizedString => messages().voice_microphone_processing_status_unavailable(empty());
const msg_voice_microphone_processing_status_off = (): LocalizedString => messages().voice_microphone_processing_status_off(empty());
const msg_voice_participants = (): LocalizedString => messages().voice_participants(empty());
const msg_voice_call_pages = (): LocalizedString => messages().voice_call_pages(empty());
const msg_voice_previous_page = (): LocalizedString => messages().voice_previous_page(empty());
const msg_voice_next_page = (): LocalizedString => messages().voice_next_page(empty());
const msg_voice_page_status = (
  inputs: Parameters<LocaleMessages['voice_page_status']>[0]
): LocalizedString => messages().voice_page_status(inputs);
const msg_voice_focus_media = (
  inputs: Parameters<LocaleMessages['voice_focus_media']>[0]
): LocalizedString => messages().voice_focus_media(inputs);
...
const msg_voice_microphone_route_problem_title = (): LocalizedString => messages().voice_microphone_route_problem_title(empty());
const msg_voice_microphone_route_reconnecting = (): LocalizedString => messages().voice_microphone_route_reconnecting(empty());
...
const msg_voice_microphone_processing_degraded = (): LocalizedString => messages().voice_microphone_processing_degraded(empty());
const msg_voice_microphone_processing_update_failed = (): LocalizedString => messages().voice_microphone_processing_update_failed(empty());
...
const msg_voice_screen_share_capability_unavailable = (): LocalizedString => messages().voice_screen_share_capability_unavailable(empty());
...
const msg_voice_companion_description_camera_only = (): LocalizedString => messages().voice_companion_description_camera_only(empty());
...
const msg_composer_room_placeholder_compact = (
  inputs: Parameters<LocaleMessages['composer_room_placeholder_compact']>[0]
): LocalizedString => messages().composer_room_placeholder_compact(inputs);
...
const msg_composer_voice_unavailable_during_call = (): LocalizedString => messages().composer_voice_unavailable_during_call(empty());
...
const msg_composer_attachment_quality_label = (): LocalizedString => messages().composer_attachment_quality_label(empty());
const msg_composer_attachment_quality_auto = (): LocalizedString => messages().composer_attachment_quality_auto(empty());
...
const msg_capture_video = (): LocalizedString => messages().capture_video(empty());
const msg_capture_camera = (): LocalizedString => messages().capture_camera(empty());
const msg_capture_quality = (): LocalizedString => messages().capture_quality(empty());
const msg_capture_quality_auto = (): LocalizedString => messages().capture_quality_auto(empty());
const msg_capture_quality_sd = (): LocalizedString => messages().capture_quality_sd(empty());
const msg_capture_quality_hd = (): LocalizedString => messages().capture_quality_hd(empty());
const msg_capture_quality_uhd = (): LocalizedString => messages().capture_quality_uhd(empty());
const msg_capture_quality_auto_hint = (): LocalizedString => messages().capture_quality_auto_hint(empty());
const msg_capture_take_photo = (): LocalizedString => messages().capture_take_photo(empty());
const msg_capture_start_video = (): LocalizedString => messages().capture_start_video(empty());
const msg_capture_stop_video = (): LocalizedString => messages().capture_stop_video(empty());
const msg_capture_retake = (): LocalizedString => messages().capture_retake(empty());
const msg_capture_use = (): LocalizedString => messages().capture_use(empty());
const msg_capture_close = (): LocalizedString => messages().capture_close(empty());
const msg_capture_permission_denied = (): LocalizedString => messages().capture_permission_denied(empty());
const msg_capture_unavailable = (): LocalizedString => messages().capture_unavailable(empty());
const msg_capture_failed = (): LocalizedString => messages().capture_failed(empty());
const msg_capture_recording = (): LocalizedString => messages().capture_recording(empty());
const msg_capture_front_camera = (): LocalizedString => messages().capture_front_camera(empty());
const msg_capture_back_camera = (): LocalizedString => messages().capture_back_camera(empty());
const msg_capture_camera_number = (
  inputs: Parameters<LocaleMessages['capture_camera_number']>[0]
): LocalizedString => messages().capture_camera_number(inputs);
...
const msg_add_server_invalid_oauth_server_url = (): LocalizedString => messages().add_server_invalid_oauth_server_url(empty());
const msg_add_server_invalid_oauth_authorization_endpoint = (): LocalizedString => messages().add_server_invalid_oauth_authorization_endpoint(empty());
...
const msg_emoji_categories_food_drink = (): LocalizedString => messages().emoji_categories_food_drink(empty());
const msg_emoji_categories_travel_places = (): LocalizedString => messages().emoji_categories_travel_places(empty());
const msg_emoji_categories_activities = (): LocalizedString => messages().emoji_categories_activities(empty());
const msg_emoji_categories_objects = (): LocalizedString => messages().emoji_categories_objects(empty());
const msg_emoji_categories_symbols = (): LocalizedString => messages().emoji_categories_symbols(empty());
const msg_emoji_categories_flags = (): LocalizedString => messages().emoji_categories_flags(empty());
...
const msg_rbac_permissions_state_allow = (): LocalizedString => messages().rbac_permissions_state_allow(empty());
const msg_rbac_permissions_state_deny = (): LocalizedString => messages().rbac_permissions_state_deny(empty());
const msg_rbac_permissions_state_neutral = (): LocalizedString => messages().rbac_permissions_state_neutral(empty());
const msg_rbac_permissions_scope_title = (
  inputs: Parameters<LocaleMessages['rbac_permissions_scope_title']>[0]
): LocalizedString => messages().rbac_permissions_scope_title(inputs);
const msg_rbac_permissions_no_scopes_available = (
  inputs: Parameters<LocaleMessages['rbac_permissions_no_scopes_available']>[0]
): LocalizedString => messages().rbac_permissions_no_scopes_available(inputs);
const msg_rbac_permissions_about_permission = (
  inputs: Parameters<LocaleMessages['rbac_permissions_about_permission']>[0]
): LocalizedString => messages().rbac_permissions_about_permission(inputs);
const msg_rbac_permissions_subject_generic = (): LocalizedString => messages().rbac_permissions_subject_generic(empty());
const msg_rbac_permissions_subject_user = (): LocalizedString => messages().rbac_permissions_subject_user(empty());
const msg_rbac_permissions_subject_role = (): LocalizedString => messages().rbac_permissions_subject_role(empty());
const msg_rbac_permissions_role_manage_title = (
  inputs: Parameters<LocaleMessages['rbac_permissions_role_manage_title']>[0]
): LocalizedString => messages().rbac_permissions_role_manage_title(inputs);
const msg_rbac_permissions_owner_always_granted_permission = (
  inputs: Parameters<LocaleMessages['rbac_permissions_owner_always_granted_permission']>[0]
): LocalizedString => messages().rbac_permissions_owner_always_granted_permission(inputs);
const msg_rbac_permissions_override_for_role_permission = (
  inputs: Parameters<LocaleMessages['rbac_permissions_override_for_role_permission']>[0]
): LocalizedString => messages().rbac_permissions_override_for_role_permission(inputs);
const msg_rbac_permissions_no_override_for_role_permission = (
  inputs: Parameters<LocaleMessages['rbac_permissions_no_override_for_role_permission']>[0]
): LocalizedString => messages().rbac_permissions_no_override_for_role_permission(inputs);
const msg_rbac_permissions_inheriting_from = (
  inputs: Parameters<LocaleMessages['rbac_permissions_inheriting_from']>[0]
): LocalizedString => messages().rbac_permissions_inheriting_from(inputs);
const msg_rbac_permissions_allow_owners_all = (): LocalizedString => messages().rbac_permissions_allow_owners_all(empty());
const msg_rbac_permissions_owner_permissions_not_editable = (): LocalizedString => messages().rbac_permissions_owner_permissions_not_editable(empty());
const msg_rbac_permissions_override_at_this_tier = (
  inputs: Parameters<LocaleMessages['rbac_permissions_override_at_this_tier']>[0]
): LocalizedString => messages().rbac_permissions_override_at_this_tier(inputs);
const msg_rbac_permissions_inherits_from = (
  inputs: Parameters<LocaleMessages['rbac_permissions_inherits_from']>[0]
): LocalizedString => messages().rbac_permissions_inherits_from(inputs);
const msg_rbac_permissions_subject_always_granted_at_scope = (
  inputs: Parameters<LocaleMessages['rbac_permissions_subject_always_granted_at_scope']>[0]
): LocalizedString => messages().rbac_permissions_subject_always_granted_at_scope(inputs);
const msg_rbac_permissions_override_for_permission_scope = (
  inputs: Parameters<LocaleMessages['rbac_permissions_override_for_permission_scope']>[0]
): LocalizedString => messages().rbac_permissions_override_for_permission_scope(inputs);
const msg_rbac_permissions_no_override_effective_scope = (
  inputs: Parameters<LocaleMessages['rbac_permissions_no_override_effective_scope']>[0]
): LocalizedString => messages().rbac_permissions_no_override_effective_scope(inputs);
const msg_rbac_permissions_subject_override_at_scope = (
  inputs: Parameters<LocaleMessages['rbac_permissions_subject_override_at_scope']>[0]
): LocalizedString => messages().rbac_permissions_subject_override_at_scope(inputs);
...
const msg_rbac_system_roles_owner_display_name = (): LocalizedString => messages().rbac_system_roles_owner_display_name(empty());
const msg_rbac_system_roles_owner_description = (): LocalizedString => messages().rbac_system_roles_owner_description(empty());
const msg_rbac_system_roles_admin_display_name = (): LocalizedString => messages().rbac_system_roles_admin_display_name(empty());
const msg_rbac_system_roles_admin_description = (): LocalizedString => messages().rbac_system_roles_admin_description(empty());
const msg_rbac_system_roles_moderator_display_name = (): LocalizedString => messages().rbac_system_roles_moderator_display_name(empty());
const msg_rbac_system_roles_moderator_description = (): LocalizedString => messages().rbac_system_roles_moderator_description(empty());
const msg_rbac_system_roles_everyone_display_name = (): LocalizedString => messages().rbac_system_roles_everyone_display_name(empty());
const msg_rbac_system_roles_everyone_description = (): LocalizedString => messages().rbac_system_roles_everyone_description(empty());
...
const msg_admin_members_invalid_display_name = (): LocalizedString => messages().admin_members_invalid_display_name(empty());
const msg_admin_members_invalid_username = (): LocalizedString => messages().admin_members_invalid_username(empty());
const msg_admin_members_update_user_failed = (): LocalizedString => messages().admin_members_update_user_failed(empty());
const msg_admin_members_user_updated = (): LocalizedString => messages().admin_members_user_updated(empty());
const msg_admin_members_clear_cooldown_failed = (): LocalizedString => messages().admin_members_clear_cooldown_failed(empty());
const msg_admin_members_cooldown_cleared = (): LocalizedString => messages().admin_members_cooldown_cleared(empty());
const msg_admin_members_user_permission_overrides_hint = (): LocalizedString => messages().admin_members_user_permission_overrides_hint(empty());
...
const msg_admin_permissions_server_not_found = (): LocalizedString => messages().admin_permissions_server_not_found(empty());
const msg_admin_permissions_update_role_failed = (): LocalizedString => messages().admin_permissions_update_role_failed(empty());
const msg_admin_permissions_update_role_ping_failed = (): LocalizedString => messages().admin_permissions_update_role_ping_failed(empty());
const msg_admin_permissions_role_pings_enabled = (): LocalizedString => messages().admin_permissions_role_pings_enabled(empty());
const msg_admin_permissions_role_pings_disabled = (): LocalizedString => messages().admin_permissions_role_pings_disabled(empty());
const msg_admin_permissions_delete_role_failed = (): LocalizedString => messages().admin_permissions_delete_role_failed(empty());
...
const msg_admin_system_performance_title = (): LocalizedString => messages().admin_system_performance_title(empty());
const msg_admin_system_performance_subtitle = (): LocalizedString => messages().admin_system_performance_subtitle(empty());
...
const msg_admin_system_performance_profile_balanced_description = (): LocalizedString => messages().admin_system_performance_profile_balanced_description(empty());
const msg_admin_system_performance_profile_performance = (): LocalizedString => messages().admin_system_performance_profile_performance(empty());
const msg_admin_system_performance_profile_performance_description = (): LocalizedString => messages().admin_system_performance_profile_performance_description(empty());
const msg_admin_system_performance_profile_custom = (): LocalizedString => messages().admin_system_performance_profile_custom(empty());
const msg_admin_system_performance_profile_custom_description = (): LocalizedString => messages().admin_system_performance_profile_custom_description(empty());
const msg_admin_system_performance_profile_legacy = (): LocalizedString => messages().admin_system_performance_profile_legacy(empty());
const msg_admin_system_performance_profile_legacy_description = (): LocalizedString => messages().admin_system_performance_profile_legacy_description(empty());
const msg_admin_system_performance_recommended = (): LocalizedString => messages().admin_system_performance_recommended(empty());
const msg_admin_system_performance_selected = (): LocalizedString => messages().admin_system_performance_selected(empty());
const msg_admin_system_performance_requested = (): LocalizedString => messages().admin_system_performance_requested(empty());
const msg_admin_system_performance_effective = (): LocalizedString => messages().admin_system_performance_effective(empty());
const msg_admin_system_performance_limits = (): LocalizedString => messages().admin_system_performance_limits(empty());
const msg_admin_system_performance_limit_summary = (
  inputs: Parameters<LocaleMessages['admin_system_performance_limit_summary']>[0]
): LocalizedString => messages().admin_system_performance_limit_summary(inputs);
const msg_admin_system_performance_custom_help = (): LocalizedString => messages().admin_system_performance_custom_help(empty());
const msg_admin_system_performance_field_image_transform_workers = (): LocalizedString => messages().admin_system_performance_field_image_transform_workers(empty());
const msg_admin_system_performance_field_image_transform_admissions = (): LocalizedString => messages().admin_system_performance_field_image_transform_admissions(empty());
const msg_admin_system_performance_field_asset_upload_workers = (): LocalizedString => messages().admin_system_performance_field_asset_upload_workers(empty());
const msg_admin_system_performance_field_link_preview_workers = (): LocalizedString => messages().admin_system_performance_field_link_preview_workers(empty());
const msg_admin_system_performance_field_video_workers = (): LocalizedString => messages().admin_system_performance_field_video_workers(empty());
const msg_admin_system_performance_process_envelope = (): LocalizedString => messages().admin_system_performance_process_envelope(empty());
const msg_admin_system_performance_cpu_count = (
  inputs: Parameters<LocaleMessages['admin_system_performance_cpu_count']>[0]
): LocalizedString => messages().admin_system_performance_cpu_count(inputs);
const msg_admin_system_performance_memory_amount = (
  inputs: Parameters<LocaleMessages['admin_system_performance_memory_amount']>[0]
): LocalizedString => messages().admin_system_performance_memory_amount(inputs);
const msg_admin_system_performance_memory_unknown = (): LocalizedString => messages().admin_system_performance_memory_unknown(empty());
const msg_admin_system_performance_capped_by = (
  inputs: Parameters<LocaleMessages['admin_system_performance_capped_by']>[0]
): LocalizedString => messages().admin_system_performance_capped_by(inputs);
const msg_admin_system_performance_cap_operator_cap = (): LocalizedString => messages().admin_system_performance_cap_operator_cap(empty());
const msg_admin_system_performance_cap_process_cpu = (): LocalizedString => messages().admin_system_performance_cap_process_cpu(empty());
const msg_admin_system_performance_cap_process_memory = (): LocalizedString => messages().admin_system_performance_cap_process_memory(empty());
const msg_admin_system_performance_cap_unknown = (): LocalizedString => messages().admin_system_performance_cap_unknown(empty());
...
const msg_admin_system_performance_save_failed = (): LocalizedString => messages().admin_system_performance_save_failed(empty());
const msg_admin_system_performance_save_conflict = (): LocalizedString => messages().admin_system_performance_save_conflict(empty());
const msg_admin_system_performance_policy_error = (): LocalizedString => messages().admin_system_performance_policy_error(empty());
const msg_admin_system_performance_custom_invalid = (): LocalizedString => messages().admin_system_performance_custom_invalid(empty());
...
export { msg_settings_profile_details_load_failed as 'settings.profile.details.load_failed' };
...
export { msg_settings_profile_details_biography_label as 'settings.profile.details.biography_label' };
export { msg_settings_profile_details_biography_placeholder as 'settings.profile.details.biography_placeholder' };
export { msg_settings_profile_details_byte_count as 'settings.profile.details.byte_count' };
export { msg_settings_profile_details_preview as 'settings.profile.details.preview' };
export { msg_settings_profile_details_biography_too_large as 'settings.profile.details.biography_too_large' };
export { msg_settings_profile_details_biography_saved as 'settings.profile.details.biography_saved' };
export { msg_settings_profile_details_save_failed as 'settings.profile.details.save_failed' };
export { msg_settings_profile_details_save_biography as 'settings.profile.details.save_biography' };
export { msg_settings_profile_details_privacy_title as 'settings.profile.details.privacy_title' };
export { msg_settings_profile_details_show_last_activity as 'settings.profile.details.show_last_activity' };
...
export { msg_profile_roles as 'profile.roles' };
export { msg_profile_member_role as 'profile.member_role' };
export { msg_profile_joined as 'profile.joined' };
export { msg_profile_last_activity as 'profile.last_activity' };
export { msg_profile_last_activity_hidden as 'profile.last_activity_hidden' };
export { msg_profile_last_activity_unavailable as 'profile.last_activity_unavailable' };
...
export { msg_room_message_empty_edit as 'room.message.empty_edit' };
export { msg_room_message_link_copied as 'room.message.link_copied' };
export { msg_room_message_link_copy_failed as 'room.message.link_copy_failed' };
export { msg_room_message_reply_target_not_loaded as 'room.message.reply_target_not_loaded' };
...
export { msg_room_workspace_switcher as 'room.workspace.switcher' };
export { msg_room_workspace_messages as 'room.workspace.messages' };
export { msg_room_workspace_call as 'room.workspace.call' };
...
export { msg_room_sidebar_show_members as 'room.sidebar.show_members' };
export { msg_room_sidebar_hide_members as 'room.sidebar.hide_members' };
export { msg_room_sidebar_show_files as 'room.sidebar.show_files' };
...
export { msg_ui_pwa_install_action_install as 'ui.pwa_install.action_install' };
...
export { msg_ui_pwa_install_benefits_label as 'ui.pwa_install.benefits_label' };
export { msg_ui_pwa_install_benefit_launch as 'ui.pwa_install.benefit_launch' };
export { msg_ui_pwa_install_benefit_focus as 'ui.pwa_install.benefit_focus' };
...
export { msg_ui_pwa_install_installing as 'ui.pwa_install.installing' };
export { msg_ui_pwa_install_install_failed as 'ui.pwa_install.install_failed' };
export { msg_ui_pwa_install_manual_help as 'ui.pwa_install.manual_help' };
export { msg_ui_pwa_install_recommended as 'ui.pwa_install.recommended' };
export { msg_ui_pwa_install_confirm_add as 'ui.pwa_install.confirm_add' };
export { msg_ui_pwa_install_confirm_install as 'ui.pwa_install.confirm_install' };
export { msg_ui_pwa_install_ios_safari_title as 'ui.pwa_install.ios_safari_title' };
export { msg_ui_pwa_install_ios_safari_share as 'ui.pwa_install.ios_safari_share' };
export { msg_ui_pwa_install_ios_safari_home as 'ui.pwa_install.ios_safari_home' };
export { msg_ui_pwa_install_ios_safari_open as 'ui.pwa_install.ios_safari_open' };
export { msg_ui_pwa_install_ios_chrome_title as 'ui.pwa_install.ios_chrome_title' };
export { msg_ui_pwa_install_ios_chrome_share as 'ui.pwa_install.ios_chrome_share' };
export { msg_ui_pwa_install_ios_chrome_home as 'ui.pwa_install.ios_chrome_home' };
export { msg_ui_pwa_install_ios_other_title as 'ui.pwa_install.ios_other_title' };
export { msg_ui_pwa_install_ios_other_open as 'ui.pwa_install.ios_other_open' };
export { msg_ui_pwa_install_ios_other_return as 'ui.pwa_install.ios_other_return' };
export { msg_ui_pwa_install_android_chromium_title as 'ui.pwa_install.android_chromium_title' };
export { msg_ui_pwa_install_android_chromium_menu as 'ui.pwa_install.android_chromium_menu' };
export { msg_ui_pwa_install_android_chromium_install as 'ui.pwa_install.android_chromium_install' };
export { msg_ui_pwa_install_android_firefox_title as 'ui.pwa_install.android_firefox_title' };
export { msg_ui_pwa_install_android_firefox_menu as 'ui.pwa_install.android_firefox_menu' };
export { msg_ui_pwa_install_android_firefox_install as 'ui.pwa_install.android_firefox_install' };
export { msg_ui_pwa_install_android_other_title as 'ui.pwa_install.android_other_title' };
export { msg_ui_pwa_install_android_other_open as 'ui.pwa_install.android_other_open' };
export { msg_ui_pwa_install_android_other_return as 'ui.pwa_install.android_other_return' };
export { msg_ui_pwa_install_android_troubleshoot as 'ui.pwa_install.android_troubleshoot' };
export { msg_ui_pwa_install_windows_firefox_title as 'ui.pwa_install.windows_firefox_title' };
export { msg_ui_pwa_install_windows_firefox_button as 'ui.pwa_install.windows_firefox_button' };
export { msg_ui_pwa_install_windows_firefox_pin as 'ui.pwa_install.windows_firefox_pin' };
export { msg_ui_pwa_install_macos_safari_title as 'ui.pwa_install.macos_safari_title' };
export { msg_ui_pwa_install_macos_safari_share as 'ui.pwa_install.macos_safari_share' };
export { msg_ui_pwa_install_macos_safari_dock as 'ui.pwa_install.macos_safari_dock' };
export { msg_ui_pwa_install_desktop_chromium_title as 'ui.pwa_install.desktop_chromium_title' };
export { msg_ui_pwa_install_desktop_chromium_icon as 'ui.pwa_install.desktop_chromium_icon' };
export { msg_ui_pwa_install_desktop_chromium_menu as 'ui.pwa_install.desktop_chromium_menu' };
export { msg_ui_pwa_install_desktop_firefox_unsupported_title as 'ui.pwa_install.desktop_firefox_unsupported_title' };
export { msg_ui_pwa_install_desktop_firefox_unsupported_linux_description as 'ui.pwa_install.desktop_firefox_unsupported_linux_description' };
export { msg_ui_pwa_install_desktop_firefox_unsupported_macos_description as 'ui.pwa_install.desktop_firefox_unsupported_macos_description' };
export { msg_ui_pwa_install_desktop_firefox_supported_browsers_linux as 'ui.pwa_install.desktop_firefox_supported_browsers_linux' };
export { msg_ui_pwa_install_desktop_firefox_supported_browsers_macos as 'ui.pwa_install.desktop_firefox_supported_browsers_macos' };
export { msg_ui_pwa_install_desktop_other_title as 'ui.pwa_install.desktop_other_title' };
export { msg_ui_pwa_install_desktop_other_open as 'ui.pwa_install.desktop_other_open' };
export { msg_ui_pwa_install_desktop_other_open_chromium as 'ui.pwa_install.desktop_other_open_chromium' };
export { msg_ui_pwa_install_desktop_other_open_macos as 'ui.pwa_install.desktop_other_open_macos' };
export { msg_ui_pwa_install_desktop_other_return as 'ui.pwa_install.desktop_other_return' };
export { msg_ui_pwa_install_reminder_title as 'ui.pwa_install.reminder_title' };
export { msg_ui_pwa_install_reminder_message as 'ui.pwa_install.reminder_message' };
export { msg_ui_pwa_install_show_guide as 'ui.pwa_install.show_guide' };
export { msg_ui_pwa_install_later as 'ui.pwa_install.later' };
...
export { msg_ui_update_after_call as 'ui.update_after_call' };
export { msg_ui_update_waiting_for_call as 'ui.update_waiting_for_call' };
...
export { msg_ui_image_modal_open_original as 'ui.image_modal.open_original' };
...
export { msg_ui_user_combobox_empty as 'ui.user_combobox.empty' };
export { msg_ui_user_combobox_clear_actor as 'ui.user_combobox.clear_actor' };
...
export { msg_quick_switcher_missing_dm_target as 'quick_switcher.missing_dm_target' };
export { msg_quick_switcher_start_dm_failed as 'quick_switcher.start_dm_failed' };
...
export { msg_preview_copy_url_success as 'preview.copy_url_success' };
export { msg_preview_copy_url_failed as 'preview.copy_url_failed' };
...
export { msg_voice_dock_connected as 'voice.dock.connected' };
export { msg_voice_dock_joining as 'voice.dock.joining' };
export { msg_voice_dock_reconnecting as 'voice.dock.reconnecting' };
export { msg_voice_dock_audio_blocked as 'voice.dock.audio_blocked' };
export { msg_voice_dock_return_to_call as 'voice.dock.return_to_call' };
export { msg_voice_dock_session_label as 'voice.dock.session_label' };
export { msg_voice_joining as 'voice.joining' };
export { msg_voice_recording_conflict as 'voice.recording_conflict' };
export { msg_voice_starting as 'voice.starting' };
export { msg_voice_already_in_another_call as 'voice.already_in_another_call' };
export { msg_voice_switch_call_action as 'voice.switch_call_action' };
export { msg_voice_switch_call_message as 'voice.switch_call_message' };
...
export { msg_voice_phone_microphone as 'voice.phone_microphone' };
export { msg_voice_headset_microphone as 'voice.headset_microphone' };
...
export { msg_voice_camera_rear as 'voice.camera_rear' };
export { msg_voice_camera_ultra_wide as 'voice.camera_ultra_wide' };
export { msg_voice_camera_telephoto as 'voice.camera_telephoto' };
export { msg_voice_switch_camera as 'voice.switch_camera' };
...
export { msg_voice_system_default_device as 'voice.system_default_device' };
export { msg_voice_default_communications_device as 'voice.default_communications_device' };
export { msg_voice_choose_speaker as 'voice.choose_speaker' };
export { msg_voice_no_devices as 'voice.no_devices' };
export { msg_voice_system_managed_audio_output as 'voice.system_managed_audio_output' };
export { msg_voice_microphone_processing_active as 'voice.microphone_processing_active' };
export { msg_voice_microphone_processing_system as 'voice.microphone_processing_system' };
export { msg_voice_microphone_processing_limited as 'voice.microphone_processing_limited' };
export { msg_voice_microphone_processing_title as 'voice.microphone_processing_title' };
export { msg_voice_microphone_noise_reduction as 'voice.microphone_noise_reduction' };
export { msg_voice_microphone_auto_gain as 'voice.microphone_auto_gain' };
export { msg_voice_microphone_echo_cancellation as 'voice.microphone_echo_cancellation' };
export { msg_voice_microphone_processing_status_native as 'voice.microphone_processing_status_native' };
export { msg_voice_microphone_processing_status_towk as 'voice.microphone_processing_status_towk' };
export { msg_voice_microphone_processing_status_requested as 'voice.microphone_processing_status_requested' };
export { msg_voice_microphone_processing_status_unavailable as 'voice.microphone_processing_status_unavailable' };
export { msg_voice_microphone_processing_status_off as 'voice.microphone_processing_status_off' };
export { msg_voice_participants as 'voice.participants' };
export { msg_voice_call_pages as 'voice.call_pages' };
export { msg_voice_previous_page as 'voice.previous_page' };
export { msg_voice_next_page as 'voice.next_page' };
export { msg_voice_page_status as 'voice.page_status' };
export { msg_voice_focus_media as 'voice.focus_media' };
...
export { msg_voice_microphone_route_problem_title as 'voice.microphone_route_problem_title' };
export { msg_voice_microphone_route_reconnecting as 'voice.microphone_route_reconnecting' };
...
export { msg_voice_microphone_processing_degraded as 'voice.microphone_processing_degraded' };
export { msg_voice_microphone_processing_update_failed as 'voice.microphone_processing_update_failed' };
...
export { msg_voice_screen_share_capability_unavailable as 'voice.screen_share_capability_unavailable' };
...
export { msg_voice_companion_description_camera_only as 'voice.companion_description_camera_only' };
...
export { msg_composer_room_placeholder_compact as 'composer.room_placeholder_compact' };
...
export { msg_composer_voice_unavailable_during_call as 'composer.voice.unavailable_during_call' };
...
export { msg_composer_attachment_quality_label as 'composer.attachment_quality.label' };
export { msg_composer_attachment_quality_auto as 'composer.attachment_quality.auto' };
...
export { msg_capture_video as 'capture.video' };
export { msg_capture_camera as 'capture.camera' };
export { msg_capture_quality as 'capture.quality' };
export { msg_capture_quality_auto as 'capture.quality_auto' };
export { msg_capture_quality_sd as 'capture.quality_sd' };
export { msg_capture_quality_hd as 'capture.quality_hd' };
export { msg_capture_quality_uhd as 'capture.quality_uhd' };
export { msg_capture_quality_auto_hint as 'capture.quality_auto_hint' };
export { msg_capture_take_photo as 'capture.take_photo' };
export { msg_capture_start_video as 'capture.start_video' };
export { msg_capture_stop_video as 'capture.stop_video' };
export { msg_capture_retake as 'capture.retake' };
export { msg_capture_use as 'capture.use' };
export { msg_capture_close as 'capture.close' };
export { msg_capture_permission_denied as 'capture.permission_denied' };
export { msg_capture_unavailable as 'capture.unavailable' };
export { msg_capture_failed as 'capture.failed' };
export { msg_capture_recording as 'capture.recording' };
export { msg_capture_front_camera as 'capture.front_camera' };
export { msg_capture_back_camera as 'capture.back_camera' };
export { msg_capture_camera_number as 'capture.camera_number' };
...
export { msg_add_server_invalid_oauth_server_url as 'add_server.invalid_oauth_server_url' };
export { msg_add_server_invalid_oauth_authorization_endpoint as 'add_server.invalid_oauth_authorization_endpoint' };
...
export { msg_emoji_categories_food_drink as 'emoji.categories.food_drink' };
export { msg_emoji_categories_travel_places as 'emoji.categories.travel_places' };
export { msg_emoji_categories_activities as 'emoji.categories.activities' };
export { msg_emoji_categories_objects as 'emoji.categories.objects' };
export { msg_emoji_categories_symbols as 'emoji.categories.symbols' };
export { msg_emoji_categories_flags as 'emoji.categories.flags' };
...
export { msg_rbac_permissions_state_allow as 'rbac.permissions.state_allow' };
export { msg_rbac_permissions_state_deny as 'rbac.permissions.state_deny' };
export { msg_rbac_permissions_state_neutral as 'rbac.permissions.state_neutral' };
export { msg_rbac_permissions_scope_title as 'rbac.permissions.scope_title' };
export { msg_rbac_permissions_no_scopes_available as 'rbac.permissions.no_scopes_available' };
export { msg_rbac_permissions_about_permission as 'rbac.permissions.about_permission' };
export { msg_rbac_permissions_subject_generic as 'rbac.permissions.subject_generic' };
export { msg_rbac_permissions_subject_user as 'rbac.permissions.subject_user' };
export { msg_rbac_permissions_subject_role as 'rbac.permissions.subject_role' };
export { msg_rbac_permissions_role_manage_title as 'rbac.permissions.role_manage_title' };
export { msg_rbac_permissions_owner_always_granted_permission as 'rbac.permissions.owner_always_granted_permission' };
export { msg_rbac_permissions_override_for_role_permission as 'rbac.permissions.override_for_role_permission' };
export { msg_rbac_permissions_no_override_for_role_permission as 'rbac.permissions.no_override_for_role_permission' };
export { msg_rbac_permissions_inheriting_from as 'rbac.permissions.inheriting_from' };
export { msg_rbac_permissions_allow_owners_all as 'rbac.permissions.allow_owners_all' };
export { msg_rbac_permissions_owner_permissions_not_editable as 'rbac.permissions.owner_permissions_not_editable' };
export { msg_rbac_permissions_override_at_this_tier as 'rbac.permissions.override_at_this_tier' };
export { msg_rbac_permissions_inherits_from as 'rbac.permissions.inherits_from' };
export { msg_rbac_permissions_subject_always_granted_at_scope as 'rbac.permissions.subject_always_granted_at_scope' };
export { msg_rbac_permissions_override_for_permission_scope as 'rbac.permissions.override_for_permission_scope' };
...
export { msg_rbac_system_roles_owner_display_name as 'rbac.system_roles.owner.display_name' };
export { msg_rbac_system_roles_owner_description as 'rbac.system_roles.owner.description' };
export { msg_rbac_system_roles_admin_display_name as 'rbac.system_roles.admin.display_name' };
export { msg_rbac_system_roles_admin_description as 'rbac.system_roles.admin.description' };
export { msg_rbac_system_roles_moderator_display_name as 'rbac.system_roles.moderator.display_name' };
export { msg_rbac_system_roles_moderator_description as 'rbac.system_roles.moderator.description' };
export { msg_rbac_system_roles_everyone_display_name as 'rbac.system_roles.everyone.display_name' };
export { msg_rbac_system_roles_everyone_description as 'rbac.system_roles.everyone.description' };
...
export { msg_admin_members_invalid_display_name as 'admin.members.invalid_display_name' };
export { msg_admin_members_invalid_username as 'admin.members.invalid_username' };
export { msg_admin_members_update_user_failed as 'admin.members.update_user_failed' };
export { msg_admin_members_user_updated as 'admin.members.user_updated' };
export { msg_admin_members_clear_cooldown_failed as 'admin.members.clear_cooldown_failed' };
export { msg_admin_members_cooldown_cleared as 'admin.members.cooldown_cleared' };
export { msg_admin_members_user_permission_overrides_hint as 'admin.members.user_permission_overrides_hint' };
...
export { msg_admin_permissions_server_not_found as 'admin.permissions.server_not_found' };
export { msg_admin_permissions_update_role_failed as 'admin.permissions.update_role_failed' };
export { msg_admin_permissions_update_role_ping_failed as 'admin.permissions.update_role_ping_failed' };
export { msg_admin_permissions_role_pings_enabled as 'admin.permissions.role_pings_enabled' };
export { msg_admin_permissions_role_pings_disabled as 'admin.permissions.role_pings_disabled' };
export { msg_admin_permissions_delete_role_failed as 'admin.permissions.delete_role_failed' };
...
export { msg_admin_system_performance_title as 'admin.system.performance_title' };
export { msg_admin_system_performance_subtitle as 'admin.system.performance_subtitle' };
...
export { msg_admin_system_performance_profile_balanced_description as 'admin.system.performance_profile_balanced_description' };
export { msg_admin_system_performance_profile_performance as 'admin.system.performance_profile_performance' };
export { msg_admin_system_performance_profile_performance_description as 'admin.system.performance_profile_performance_description' };
export { msg_admin_system_performance_profile_custom as 'admin.system.performance_profile_custom' };
export { msg_admin_system_performance_profile_custom_description as 'admin.system.performance_profile_custom_description' };
export { msg_admin_system_performance_profile_legacy as 'admin.system.performance_profile_legacy' };
export { msg_admin_system_performance_profile_legacy_description as 'admin.system.performance_profile_legacy_description' };
export { msg_admin_system_performance_recommended as 'admin.system.performance_recommended' };
export { msg_admin_system_performance_selected as 'admin.system.performance_selected' };
export { msg_admin_system_performance_requested as 'admin.system.performance_requested' };
export { msg_admin_system_performance_effective as 'admin.system.performance_effective' };
export { msg_admin_system_performance_limits as 'admin.system.performance_limits' };
export { msg_admin_system_performance_limit_summary as 'admin.system.performance_limit_summary' };
export { msg_admin_system_performance_custom_help as 'admin.system.performance_custom_help' };
export { msg_admin_system_performance_field_image_transform_workers as 'admin.system.performance_field_image_transform_workers' };
export { msg_admin_system_performance_field_image_transform_admissions as 'admin.system.performance_field_image_transform_admissions' };
export { msg_admin_system_performance_field_asset_upload_workers as 'admin.system.performance_field_asset_upload_workers' };
export { msg_admin_system_performance_field_link_preview_workers as 'admin.system.performance_field_link_preview_workers' };
export { msg_admin_system_performance_field_video_workers as 'admin.system.performance_field_video_workers' };
export { msg_admin_system_performance_process_envelope as 'admin.system.performance_process_envelope' };
export { msg_admin_system_performance_cpu_count as 'admin.system.performance_cpu_count' };
export { msg_admin_system_performance_memory_amount as 'admin.system.performance_memory_amount' };
export { msg_admin_system_performance_memory_unknown as 'admin.system.performance_memory_unknown' };
export { msg_admin_system_performance_capped_by as 'admin.system.performance_capped_by' };
export { msg_admin_system_performance_cap_operator_cap as 'admin.system.performance_cap_operator_cap' };
export { msg_admin_system_performance_cap_process_cpu as 'admin.system.performance_cap_process_cpu' };
export { msg_admin_system_performance_cap_process_memory as 'admin.system.performance_cap_process_memory' };
export { msg_admin_system_performance_cap_unknown as 'admin.system.performance_cap_unknown' };
...
export { msg_admin_system_performance_save_failed as 'admin.system.performance_save_failed' };
export { msg_admin_system_performance_save_conflict as 'admin.system.performance_save_conflict' };
export { msg_admin_system_performance_policy_error as 'admin.system.performance_policy_error' };
export { msg_admin_system_performance_custom_invalid as 'admin.system.performance_custom_invalid' };
