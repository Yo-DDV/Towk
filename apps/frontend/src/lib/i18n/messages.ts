...
const msg_ui_pwa_install_android_standalone_notice_title = (): LocalizedString => messages().ui_pwa_install_android_standalone_notice_title(empty());
const msg_ui_pwa_install_android_standalone_notice_body = (): LocalizedString => messages().ui_pwa_install_android_standalone_notice_body(empty());
const msg_ui_pwa_install_android_standalone_notice_open_in_browser = (): LocalizedString => messages().ui_pwa_install_android_standalone_notice_open_in_browser(empty());
const msg_ui_pwa_install_android_standalone_notice_close_old_app = (): LocalizedString => messages().ui_pwa_install_android_standalone_notice_close_old_app(empty());
...
export { msg_ui_pwa_install_android_standalone_notice_title as 'ui.pwa_install.android_standalone_notice.title' };
export { msg_ui_pwa_install_android_standalone_notice_body as 'ui.pwa_install.android_standalone_notice.body' };
export { msg_ui_pwa_install_android_standalone_notice_open_in_browser as 'ui.pwa_install.android_standalone_notice.open_in_browser' };
export { msg_ui_pwa_install_android_standalone_notice_close_old_app as 'ui.pwa_install.android_standalone_notice.close_old_app' };
