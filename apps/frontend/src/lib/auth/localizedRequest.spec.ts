...
import { localizedHeaders, localizedJSONHeaders, TOWK_LOCALE_HEADER } from './localizedRequest';
...
describe('localizedJSONHeaders', () => {
  ...
  it('adds only the selected locale to non-JSON requests', () => {
    const headers = localizedHeaders({ Accept: 'application/json' });
