...
<div
  ...
  class="@container absolute inset-1 z-30 flex min-h-0 flex-col overflow-hidden rounded-lg border border-text/15 bg-surface-100/98 text-text shadow-xl backdrop-blur-md"
