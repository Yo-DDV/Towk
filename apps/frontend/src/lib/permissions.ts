...
export const PERMISSION_METADATA: Record<string, PermissionMetadata> = {
  ...
  'room.lock': {
    description: m['rbac.permission_descriptions.room_lock'],
    risk: 'moderation'
  },
  'room.purge-messages': {
    description: m['rbac.permission_descriptions.room_purge_messages'],
    risk: 'destructive'
  },
  'room.bypass-lock': {
    description: m['rbac.permission_descriptions.room_bypass_lock'],
    risk: 'moderation'
  },
  'message.post': {
  ...
  'message.delete-others': {
    description: m['rbac.permission_descriptions.message_delete_others'],
    risk: 'moderation'
  },
  'message.manage': {
