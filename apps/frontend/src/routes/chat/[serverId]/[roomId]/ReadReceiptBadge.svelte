<script lang="ts">
  ...
  function escapeDismissal(_el: HTMLElement) {
    void _el;
...
<FloatingPopover
  ...
  {anchor}
  role="dialog"
  ariaLabel={m['room.message.read_receipts.title']()}
  class="w-[min(22rem,calc(100vw-2rem))] menu"
  onclose={close}
>
  <div
    class="flex flex-col gap-2 menu-section p-3 text-sm"
    {@attach popoverGestureBoundary}
    {@attach escapeDismissal}
  >
