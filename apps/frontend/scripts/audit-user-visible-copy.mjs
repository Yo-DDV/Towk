...
const SUSPICIOUS_TRANSLATIONS = [
  ...
  [
    'pt',
    /\b(?:ficheiros?|ecrã|respetiv[ao]|iniciar sessão|partilh(?:ar|ad[oa]s?|e)|aplicaç(?:ão|ões)|afix(?:ar|á-lo)|multimédia|workers?)\b/i,
    'European Portuguese or untranslated term in the pt-BR catalog'
  ],
  [
    'pt',
    /\b(?:A (?:abrir|carregar|gravar|preparar)|definições|demasiad[oa]s?|regresse)\b/i,
