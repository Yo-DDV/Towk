...
const file_chatto_admin_v1_roles_proto_rawDesc = "" +
	...
	"\x17viewer_can_assign_roles\x18\x04 \x01(\bR\x14viewerCanAssignRoles\"\xe3\x01\n" +
	...
	"\bpingable\x18\x04 \x01(\bR\bpingable\x123\n" +
	"\x05color\x18\x05 \x01(\tB\x18\xbaH\x15r\x132\x11^#[0-9A-Fa-f]{6}$H\x00R\x05color\x88\x01\x01B\b\n" +
	"\x06_color\"D\n" +
	"\x12CreateRoleResponse\x12.\n" +
	"\x04role\x18\x01 \x01(\v2\x1a.chatto.admin.v1.AdminRoleR\x04role\"\xa0\x02\n" +
	...
	"\bpingable\x18\x04 \x01(\bH\x02R\bpingable\x88\x01\x01\x123\n" +
	"\x05color\x18\x05 \x01(\tB\x18\xbaH\x15r\x132\x11^#[0-9A-Fa-f]{6}$H\x03R\x05color\x88\x01\x01B\x0f\n" +
	"\r_display_nameB\x0e\n" +
	"\f_descriptionB\v\n" +
	"\t_pingableB\b\n" +
	"\x06_color\"D\n" +
...
func file_chatto_admin_v1_roles_proto_init() {
	...
	file_chatto_admin_v1_roles_proto_msgTypes[5].OneofWrappers = []any{}
