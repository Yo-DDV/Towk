...
func (x *CreateMessageRequest) GetClientRequestId() string {
	if x != nil {
...
const file_chatto_api_v1_messages_proto_rawDesc = "" +
	"\n" +
	"\x1cchatto/api/v1/messages.proto\x12\rchatto.api.v1\x1a\x1bbuf/validate/validate.proto\x1a!chatto/api/v1/link_previews.proto\x1a!chatto/api/v1/message_types.proto\x1a\x1dchatto/api/v1/reactions.proto\"\xc0\x03\n" +
	...
	"\x14attachment_asset_ids\x18\x03 \x03(\tB\x12\xbaH\x0f\x92\x01\f\x10\n" +
	"\x18\x01\"\x06r\x04\x10\x01(\x0fR\x12attachmentAssetIds\x12/\n" +
	...
	" \x01(\tR\x10linkPreviewToken\x123\n" +
	"\x11client_request_id\x18\v \x01(\tB\a\xbaH\x04r\x02(@R\x0fclientRequestIdJ\x04\b\b\x10\tJ\x04\b\t\x10\n" +
