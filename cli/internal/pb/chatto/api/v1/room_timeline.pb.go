...
type RoomTimelinePostingPolicyEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RoomId        string                 `protobuf:"bytes,1,opt,name=room_id,json=roomId,proto3" json:"room_id,omitempty"`
...
func (x *RoomTimelinePostingPolicyEvent) Reset() {
	*x = RoomTimelinePostingPolicyEvent{}
	mi := &file_chatto_api_v1_room_timeline_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RoomTimelinePostingPolicyEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RoomTimelinePostingPolicyEvent) ProtoMessage() {}

func (x *RoomTimelinePostingPolicyEvent) ProtoReflect() protoreflect.Message {
	mi := &file_chatto_api_v1_room_timeline_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RoomTimelinePostingPolicyEvent.ProtoReflect.Descriptor instead.
func (*RoomTimelinePostingPolicyEvent) Descriptor() ([]byte, []int) {
	return file_chatto_api_v1_room_timeline_proto_rawDescGZIP(), []int{2}
}

func (x *RoomTimelinePostingPolicyEvent) GetRoomId() string {
	if x != nil {
		return x.RoomId
	}
	return ""
...
func (x *RoomTimelinePostingPolicyEvent) GetLocked() bool {
	if x != nil {
		return x.Locked
	}
	return false
...
type RoomTimelineHistoryPurgedEvent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RoomId        string                 `protobuf:"bytes,1,opt,name=room_id,json=roomId,proto3" json:"room_id,omitempty"`
...
func (x *RoomTimelineHistoryPurgedEvent) Reset() {
	*x = RoomTimelineHistoryPurgedEvent{}
	mi := &file_chatto_api_v1_room_timeline_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RoomTimelineHistoryPurgedEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RoomTimelineHistoryPurgedEvent) ProtoMessage() {}

func (x *RoomTimelineHistoryPurgedEvent) ProtoReflect() protoreflect.Message {
	mi := &file_chatto_api_v1_room_timeline_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RoomTimelineHistoryPurgedEvent.ProtoReflect.Descriptor instead.
func (*RoomTimelineHistoryPurgedEvent) Descriptor() ([]byte, []int) {
	return file_chatto_api_v1_room_timeline_proto_rawDescGZIP(), []int{3}
}

func (x *RoomTimelineHistoryPurgedEvent) GetRoomId() string {
	if x != nil {
		return x.RoomId
	}
	return ""
...
func (x *RoomTimelineHistoryPurgedEvent) GetHistoryEpoch() uint64 {
	if x != nil {
...
type RoomTimelineEvent struct {
	...
	//	*RoomTimelineEvent_RoomPostingPolicyChanged
	//	*RoomTimelineEvent_RoomHistoryPurged
...
func (x *RoomTimelineEvent) GetRoomPostingPolicyChanged() *RoomTimelinePostingPolicyEvent {
	if x != nil {
		if x, ok := x.Event.(*RoomTimelineEvent_RoomPostingPolicyChanged); ok {
...
func (x *RoomTimelineEvent) GetRoomHistoryPurged() *RoomTimelineHistoryPurgedEvent {
	if x != nil {
		if x, ok := x.Event.(*RoomTimelineEvent_RoomHistoryPurged); ok {
...
type RoomTimelineEvent_RoomPostingPolicyChanged struct {
	// The channel posting policy changed.
	RoomPostingPolicyChanged *RoomTimelinePostingPolicyEvent `protobuf:"bytes,25,opt,name=room_posting_policy_changed,json=roomPostingPolicyChanged,proto3,oneof"`
}

type RoomTimelineEvent_RoomHistoryPurged struct {
	// Earlier message-owned history was purged.
	RoomHistoryPurged *RoomTimelineHistoryPurgedEvent `protobuf:"bytes,26,opt,name=room_history_purged,json=roomHistoryPurged,proto3,oneof"`
}
...
func (*RoomTimelineEvent_RoomPostingPolicyChanged) isRoomTimelineEvent_Event() {}

func (*RoomTimelineEvent_RoomHistoryPurged) isRoomTimelineEvent_Event() {}
...
const file_chatto_api_v1_room_timeline_proto_rawDesc = "" +
	...
	"\x1eRoomTimelinePostingPolicyEvent\x12\x17\n" +
	"\aroom_id\x18\x01 \x01(\tR\x06roomId\x12\x16\n" +
	"\x06locked\x18\x02 \x01(\bR\x06locked\"^\n" +
	"\x1eRoomTimelineHistoryPurgedEvent\x12\x17\n" +
	"\aroom_id\x18\x01 \x01(\tR\x06roomId\x12#\n" +
	"\rhistory_epoch\x18\x02 \x01(\x04R\fhistoryEpoch\"E\n" +
	"\x11RoomMessagePosted\x120\n" +
	"\amessage\x18\x01 \x01(\v2\x16.chatto.api.v1.MessageR\amessage\"\x8b\n" +
	"\n" +
	...
	"\x0froom_unarchived\x18\x18 \x01(\v2$.chatto.api.v1.RoomTimelineRoomEventH\x00R\x0eroomUnarchived\x12n\n" +
	"\x1broom_posting_policy_changed\x18\x19 \x01(\v2-.chatto.api.v1.RoomTimelinePostingPolicyEventH\x00R\x18roomPostingPolicyChanged\x12_\n" +
	"\x13room_history_purged\x18\x1a \x01(\v2-.chatto.api.v1.RoomTimelineHistoryPurgedEventH\x00R\x11roomHistoryPurged\x12P\n" +
...
var file_chatto_api_v1_room_timeline_proto_goTypes = []any{
	...
	(*RoomTimelinePostingPolicyEvent)(nil), // 2: chatto.api.v1.RoomTimelinePostingPolicyEvent
	(*RoomTimelineHistoryPurgedEvent)(nil), // 3: chatto.api.v1.RoomTimelineHistoryPurgedEvent
	...
	(*RoomTimelineCallEvent)(nil),          // 15: chatto.api.v1.RoomTimelineCallEvent
	nil,                                    // 16: chatto.api.v1.RoomTimelineIncludes.UsersEntry
...
var file_chatto_api_v1_room_timeline_proto_depIdxs = []int32{
	16, // 0: chatto.api.v1.RoomTimelineIncludes.users:type_name -> chatto.api.v1.RoomTimelineIncludes.UsersEntry
	17, // 1: chatto.api.v1.RoomMessagePosted.message:type_name -> chatto.api.v1.Message
	18, // 2: chatto.api.v1.RoomTimelineEvent.created_at:type_name -> google.protobuf.Timestamp
	4,  // 3: chatto.api.v1.RoomTimelineEvent.message_posted:type_name -> chatto.api.v1.RoomMessagePosted
	...
	2,  // 9: chatto.api.v1.RoomTimelineEvent.room_posting_policy_changed:type_name -> chatto.api.v1.RoomTimelinePostingPolicyEvent
	3,  // 10: chatto.api.v1.RoomTimelineEvent.room_history_purged:type_name -> chatto.api.v1.RoomTimelineHistoryPurgedEvent
	...
	15, // 13: chatto.api.v1.RoomTimelineEvent.call_started:type_name -> chatto.api.v1.RoomTimelineCallEvent
	15, // 14: chatto.api.v1.RoomTimelineEvent.call_participant_joined:type_name -> chatto.api.v1.RoomTimelineCallEvent
	15, // 15: chatto.api.v1.RoomTimelineEvent.call_participant_left:type_name -> chatto.api.v1.RoomTimelineCallEvent
	15, // 16: chatto.api.v1.RoomTimelineEvent.call_ended:type_name -> chatto.api.v1.RoomTimelineCallEvent
	5,  // 17: chatto.api.v1.RoomTimelinePage.events:type_name -> chatto.api.v1.RoomTimelineEvent
	0,  // 18: chatto.api.v1.RoomTimelinePage.includes:type_name -> chatto.api.v1.RoomTimelineIncludes
	6,  // 19: chatto.api.v1.GetRoomEventsResponse.page:type_name -> chatto.api.v1.RoomTimelinePage
	6,  // 20: chatto.api.v1.GetRoomEventsAroundResponse.page:type_name -> chatto.api.v1.RoomTimelinePage
	6,  // 21: chatto.api.v1.GetThreadEventsResponse.page:type_name -> chatto.api.v1.RoomTimelinePage
	6,  // 22: chatto.api.v1.GetThreadEventsAroundResponse.page:type_name -> chatto.api.v1.RoomTimelinePage
	19, // 23: chatto.api.v1.RoomTimelineIncludes.UsersEntry.value:type_name -> chatto.api.v1.User
...
func file_chatto_api_v1_room_timeline_proto_init() {
	...
	file_chatto_api_v1_room_timeline_proto_msgTypes[5].OneofWrappers = []any{
		...
		(*RoomTimelineEvent_RoomPostingPolicyChanged)(nil),
		(*RoomTimelineEvent_RoomHistoryPurged)(nil),
