...
const file_chatto_api_v1_read_state_proto_rawDesc = "" +
	...
	"\aupdated\x18\x01 \x01(\bR\aupdated\"\x8f\x01\n" +
	"\x12ReadReceiptSummary\x12(\n" +
	"\x10message_event_id\x18\x01 \x01(\tR\x0emessageEventId\x12!\n" +
	"\freader_count\x18\x02 \x01(\x05R\vreaderCountJ\x04\b\x03\x10\x04J\x04\b\x04\x10\x05R\x10preview_user_idsR\x0elatest_read_at\"\xa9\x01\n" +
...
var file_chatto_api_v1_read_state_proto_depIdxs = []int32{
	...
	6,  // 3: chatto.api.v1.GetReadReceiptSummariesResponse.summaries:type_name -> chatto.api.v1.ReadReceiptSummary
	13, // 4: chatto.api.v1.ListReadReceiptReadersRequest.page:type_name -> chatto.api.v1.PageRequest
	14, // 5: chatto.api.v1.ReadReceiptReader.user:type_name -> chatto.api.v1.User
	12, // 6: chatto.api.v1.ReadReceiptReader.read_at:type_name -> google.protobuf.Timestamp
	10, // 7: chatto.api.v1.ListReadReceiptReadersResponse.readers:type_name -> chatto.api.v1.ReadReceiptReader
	15, // 8: chatto.api.v1.ListReadReceiptReadersResponse.page:type_name -> chatto.api.v1.PageInfo
