...
- `.agents/skills/**` — workflow skills. Use them when the task names one or clearly matches one, especially `towk-architecture`, `glossary`, Svelte skills, ADR/FDR skills, and security/release workflows.
