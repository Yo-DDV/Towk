...
8. **Update `docs/fdr/` and `docs/ARCHITECTURE.md` to drop residual "space" prose** that survived ADR-029's docs sweep (those described what the code looked like at the time; this ADR makes them stale).
