...
2. **Public API hard rename**: API names break. Per early-stage policy ([CONTRIBUTING.md](../../CONTRIBUTING.md)), external consumers re-codegen. Soft deprecation rejected as needless ceremony for this stage.
