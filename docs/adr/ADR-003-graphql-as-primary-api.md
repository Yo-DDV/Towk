...
- **Schema changes are potentially breaking**: Changes to `.graphqls` files affect all clients. Managed carefully according to the compatibility expectations in [CONTRIBUTING.md](../../CONTRIBUTING.md).
