...
- **Documentation churn.** Several feature docs referenced "instance" and "space" as distinct concepts. They will be updated phase-by-phase as the underlying behaviour changes, not pre-emptively.
