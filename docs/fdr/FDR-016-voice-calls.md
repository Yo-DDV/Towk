...
- When two connections from one account are present, participant cards remain connection-distinct and show localized Device 1 / Device 2 badges. Account-level actions such as opening a profile or starting a direct message still target the underlying account, not the media-session identity.
