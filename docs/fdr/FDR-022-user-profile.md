...
- **Profile actions** — the server returns viewer-specific Message and Call capabilities. The call action is exposed only when direct messaging is allowed and LiveKit is configured. Deleted accounts expose neither action.
