...
- **ADRs:** ADR-004 (Authorization at the API Boundary), ADR-028 (Event-ID-Keyed Read State), ADR-033 (Event-Sourced State with Derived Projections), ADR-054 (Read Receipt Publication Boundary)
